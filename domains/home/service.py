...
def get_credentials(users_collection, request):
    ...
    log_result_test = log(os.getenv("LOGARBOR_HOME_SERVICE_ID"), "info", "user got their credentials successufully", "6177b289-2b6f-44ea-a542-e2238263bd4e")

    log(os.getenv("LOGARBOR_SERVICES_SERVICE_ID"), "info", f"{log_result_test}", os.getenv("LOGARBOR_SUPPORT_TEAM_ACCESS_TOKEN"))
