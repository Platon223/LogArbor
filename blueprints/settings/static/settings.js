...
async function main() {
    ...
    if (settings.message instanceof Object) {
        if (settings.message.auth_provider !== "LogArbor") {
            document.getElementById("settings-container").innerHTML = `<div style="margin-bottom: 50px; min-height: none; height: 500px;" class="terminal">
            ...
            <!-- API -->
            <div style="margin-bottom: 50px; min-height: none; height: 500px;" class="terminal">
                <div class="terminal-header">
                    <span>API Keys</span>
                    <span class="terminal-dot"></span>
                </div>
            ...
            <!-- Danger Zone -->
            <div style="margin-bottom: 20px; min-height: none; height: 500px;" class="terminal danger-zone">
                <div class="terminal-header">
